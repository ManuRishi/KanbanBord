...
public class TaskRepositoryTest
{
    ...
    public void setUp()
    {
        task = new Task("1","chaitanya@gmail.com","todo","high","Backend","Space1","part of Main Project",new Date(2022-04-22),new Date(2022-04-25));
    }
    ...
    {
        taskRepository.insert(task);
        Task task1 = new Task("2","chaitanya@gmail.com","todo","high","Backend","Space1","part of Main Project",new Date(2022-04-22),new Date(2022-04-25));
